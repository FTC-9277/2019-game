...
public class DepotPark extends ExplosiveAuto{
    ...
    public void body() throws InterruptedException {
        ...
        if(mineralPosition == 3){
            ...
            robot.drive.resetEncoders();
            robot.drive.autoScaledTurn(-60,0.3,0.89);
            robot.drive.resetEncoders();
            robot.drive.autoScaledDrive(-250, 0.5, 0.89);
            robot.drive.resetEncoders();
            robot.drive.autoScaledTurn(10,0.3,0.89);
            robot.drive.resetEncoders();
            robot.drive.autoScaledDrive(-1450, 0.8,0.89);
            ...
            marker.setPosition(0.5);
            robot.drive.resetEncoders();
            robot.drive.autoScaledTurn(-30,0.3,0.89);
            robot.drive.resetEncoders();
            robot.drive.autoScaledDrive(-1350,0.5,0.89);
            ...
            marker.setPosition(0.5);
            robot.drive.resetEncoders();
            robot.drive.autoScaledTurn(75,0.3,0.89);
            robot.drive.resetEncoders();
            robot.drive.autoScaledDrive(400,0.5,0.89);
            robot.drive.resetEncoders();
            robot.drive.autoScaledTurn(60,0.3,0.89);
            robot.drive.resetEncoders();
            robot.drive.autoScaledDrive(1500,0.8,0.89);
        }
