...
/*
        ...
        if(mineralPosition == 3){ // middle mineral
            ...
            robot.driveSubsystem.driveEncoders(-200, -0.5);
            robot.driveSubsystem.driveEncoders(-1500,-0.8);
            ...
            marker.setPosition(0);
            waitMillis(1000);
            robot.driveSubsystem.turn(32);
            robot.driveSubsystem.driveEncoders(-1550,-0.9);
            ...
            robot.driveSubsystem.driveEncoders(600,0.8);
            robot.driveSubsystem.turn(-45);
            robot.driveSubsystem.driveEncoders(400, 0.8);
        }
    }
    @Override
